...
with DAG(
    ...
    # ==== TÂCHE 3 : Lancer le job Spark ====
    run_py_spark_job = BashOperator(
        task_id='run_py_spark_job',
        bash_command='cd /opt/airflow/scripts && spark-submit py_spark/pyspark_streaming_meteo.py'
    )

    # ==== DÉPENDANCES ====
    fetch_and_send_weather >> verify_pipeline >> run_py_spark_job